...
public class MaterialImageView extends ImageView {
    ...
    public static final int MaterialImageView_shadow_size = 0;
    public static final int MaterialImageView_radius_size = 1;
    public static final int MaterialImageView_use_white_bg = 2;
    ...
    public static final int[] MaterialImageView = {
    ...
    public void init(Context context, AttributeSet attrs, Resources resources, int defStyleAttr){
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs,MaterialImageView,
                defStyleAttr, 0);

        int shadowSize = a.getInt(MaterialImageView_shadow_size, 0);
        radius = a.getInt(MaterialImageView_radius_size, 5);//radius size
        mUseWhiteBackground = a.getBoolean(MaterialImageView_use_white_bg, false);
    ...
    private void buildShadowCorners() {
        ...
        mCornerShadowPaint.setShader(
                new RadialGradient(0.0F, 0.0F, mCornerRadius + mShadowSize,
